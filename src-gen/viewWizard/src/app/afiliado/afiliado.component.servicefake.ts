...
const AFILIADO_API: string = "./assets/data/afiliado.json";

@Injectable()
export class AfiliadoFakeService {
    ...
    getAllAfiliado(){
     	return this.http.get(AFILIADO_API).map(res => res.json().afiliados).catch((error: any) => Observable.throw(error.json()));
    }
