...
const BENEFICIARIO_API: string = "./assets/data/beneficiario.json";

@Injectable()
export class BeneficiarioFakeService {
    ...
    getAllBeneficiario(){
     	return this.http.get(BENEFICIARIO_API).map(res => res.json().beneficiarios).catch((error: any) => Observable.throw(error.json()));
    }
